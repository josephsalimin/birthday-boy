...
export const REPLY_MESSAGE = {
  NOT_REGISTERED: `Hi! We've detected that you are currently not registered in our server.\nPlease provide use first with your first name! Thank you!`,
  INVALID_NAME: `Can you please restate your name? Thank you!`,
  NAME_ADDED: `Hello %s! It is very nice to know you! For further registration, can you provide me your birthday (YYYY-MM-DD format)? Thank you!`,
